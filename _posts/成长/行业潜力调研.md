...
数据逐渐由资源变为资产，既然是资产那么在数据的收集/采集方面大企业大公司将具备先天优势，数据的诞生将依赖于硬件、软件、业务系统等，这种天然的护城河使得小企业难以涉足。就像马云说的，今后大数据会成为互联网的土壤，只有基于大数据的云计算才更有价值，只有基于大数据的AI才更加智能。毫不夸张的说，大数据属于金字塔底座，属于根基。
